...
public struct BottleInfo: Codable, Equatable {
    ...
    // When the app was last launched, for the library row's "Last played"
    // line. Nil means it has never been launched.
...
public struct BottleSettings: Codable, Equatable {
    ...
    /// When this app was last launched, surfaced as the library row's "Last
    /// played" line. Nil until the first launch.
    public var lastLaunched: Date? {
        get { return info.lastLaunched }
        set { info.lastLaunched = newValue }
    }
